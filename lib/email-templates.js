export const getSignatureHtml = () => {
  const logoUrl = 'https://alvfyayrabxzxthcjphx.supabase.co/storage/v1/object/public/public-assets/Favicon.jpg';
  return `
  ...
  <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
    <tr>
      <td style="padding-right: 20px; text-align: center; vertical-align: top;">
        <img src="${logoUrl}" alt="PrimeRealOps" width="80" height="80" style="border-radius: 50%; display: block; margin: 0 auto 10px auto; object-fit: cover;" />
        <a href="https://calendly.com/primerealops/primerealops-discovery-call" style="color: #4f46e5; font-weight: bold; text-decoration: none; font-size: 13px; display: block; text-align: center;">Book A Call</a>
      </td>
