...
export const getInvoiceEmailHtml = (orgName, month, totalMinutes, baseFee, usageCost, subtotal, discount, overage, totalAmount, dueDate) => `
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px;">
  ...
  <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin: 20px 0;">
    <table style="width: 100%; border-collapse: collapse;">
      <tr><td style="padding: 8px 0;"><strong>Base Platform Fee:</strong></td><td style="text-align: right;">$${baseFee.toFixed(2)}</td></tr>
      <tr><td style="padding: 8px 0;"><strong>Usage Cost (${totalMinutes} mins):</strong></td><td style="text-align: right;">$${usageCost.toFixed(2)}</td></tr>
