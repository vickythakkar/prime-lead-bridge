...
export const getInvoiceEmailHtml = (orgName, month, totalMinutes, baseFee, usageCost, subtotal, discount, overage, totalAmount, dueDate, planName) => `
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px;">
  <h2>Prime Lead Bridge</h2>
  <p>A product of Prime Real Ops</p>
  <p>Hi ${orgName},</p>
  <p>Your invoice for the month of <strong>${month}</strong> has been generated.</p>
