export const getSignatureHtml = () => {
  const logoUrl = 'https://ui-avatars.com/api/?name=PR&background=4f46e5&color=fff&rounded=true&size=80&font-size=0.4';
  return `
  ...
  <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
    <tr>
      <td style="padding-right: 20px; text-align: center; vertical-align: middle;">
        <img src="${logoUrl}" alt="PrimeRealOps" width="80" height="80" style="border-radius: 50%; display: block; margin: 0 auto 12px auto; object-fit: cover;" />
        <a href="https://calendly.com/primerealops/primerealops-discovery-call" style="color: #4f46e5; font-weight: bold; text-decoration: none; font-size: 14px; display: inline-block;">Book A Call</a>
      </td>
      <td style="border-left: 3px solid #4f46e5; padding-left: 20px; vertical-align: middle;">
        ...
        <p style="margin: 0 0 15px 0; font-size: 13px; color: #4b5563;">
          <span style="color: #e11d48; margin-right: 5px;">✉️</span> support@primerealops.com
        </p>
