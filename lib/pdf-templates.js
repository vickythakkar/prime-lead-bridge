export const getInvoicePdfHtml = (invoice, orgName, period, baseFee, usageCost, planName) => {
        ...
        <div class="glass-card">
          ...
          <div class="details">
            <div style="display: flex; justify-content: space-between;">
              ...
              <div style="text-align: right;">
                <p><strong>Invoice ID:</strong> ${invoice.id.slice(0,8).toUpperCase()}<br/>
          ...
          <div class="footer">
            <div class="footer-left">
              ...
              <p>?? +1 (929) 833-8166 | ?? info@primerealops.com</p>
              <p>
