...
export async function GET(request) {
  ...
  try {
    ...
    let query = supabaseAdmin
      .from('call_logs')
      .select('id, created_at, from_number, to_number, call_type, status, duration, recording_url, seen, notes, disposition, organizations(name, company_name), contacts(name)')
