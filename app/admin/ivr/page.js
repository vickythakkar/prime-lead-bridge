...
import NumberIVRBuilder from '../../dashboard/ivr/NumberIVRBuilder';
...
export default function AdminIVRPage() {
  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white tracking-tight mb-2">Platform IVR Builder</h1>
        <p className="text-slate-400">Create custom call routing workflows for the platform's global phone numbers.</p>
      </div>

      {numbers.length === 0 ? (
        <div className="glass-card rounded-2xl p-8 border border-white/10 text-center">
          <p className="text-slate-400 mb-4">You don't have any active platform phone numbers yet.</p>
        </div>
      ) : (
