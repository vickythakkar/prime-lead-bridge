  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-7xl mx-auto">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-white">System Trash</h1>
        <p className="text-slate-400 mt-1">Global recycle bin for all organizations.</p>
      </header>
            ...
            <table className="w-full text-left">
              <thead className="bg-slate-900/40 border-b border-white/10">
                <tr>
                  ...
                  <th className="px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Org ID</th>
