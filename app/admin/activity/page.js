...
import AdminCallWrapUpModal from '../components/AdminCallWrapUpModal';
  ...
  return (
    <div className="animate-in fade-in duration-500 w-full">
            ...
            <table className="w-full text-left">
              <thead className="bg-white/5 border-b border-white/10">
                <tr>
                  ...
                  <th className="px-4 py-3 text-sm font-semibold text-slate-300 whitespace-nowrap">Organization</th>
      ...
      <AdminCallWrapUpModal 
        ...
        callDetails={{ 
          callSid: editingNote?.twilio_call_sid,
          phoneNumber: editingNote?.call_type === 'outbound' ? editingNote?.to_number : editingNote?.from_number
        }} 
