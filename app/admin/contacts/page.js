                    ...
                    <td className="px-6 py-4 text-right whitespace-nowrap">
                      <div className="flex justify-end gap-3 items-center">
                        {c.phone && (
                          <>
                            <a 
                              href={`/admin/messages?phone=${encodeURIComponent(c.phone)}`} 
                            ...
                            <a 
                              href={`/admin/dialer?phone=${encodeURIComponent(c.phone)}&name=${encodeURIComponent(c.name)}`} 
                        ...
                        <button onClick={() => startEdit(c)} className="text-slate-400 hover:text-white transition-colors ml-2" title="Edit">
                        ...
                        <button onClick={() => handleDelete(c.id)} className="text-slate-400 hover:text-rose-400 transition-colors ml-2" title="Delete">
